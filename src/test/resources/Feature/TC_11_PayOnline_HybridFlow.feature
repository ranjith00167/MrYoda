...
Feature: Place lab orders and complete payment via UI, then verify via getOrderById API
  ...
  # ─────────────────────────────────────────────────────────────────────────────
  # Scenario 4 : Single Member – Lab Visit – Reward + Coupon – Pay Online
  # ─────────────────────────────────────────────────────────────────────────────
  @hybridLabOrderMemberRewardCoupon
  ...
  # ─────────────────────────────────────────────────────────────────────────────
  # Scenario 5 : Multi-Member – Lab Visit – Reward + Coupon – Pay Online
  # ─────────────────────────────────────────────────────────────────────────────
  @hybridMultiMemberRewardCoupon
  Scenario: Multi-member places a lab visit order with reward and coupon via UI and verifies via getOrderById API
    # ── UI : Login ──────────────────────────────────────────────────────────────
    ...
    Then generate API response capture report for validation analysis
  # ─────────────────────────────────────────────────────────────────────────────
  # Scenario 4B : Multi-Member – Lab Visit – Reward Only – Pay Online
  # ─────────────────────────────────────────────────────────────────────────────
  @hybridMultiMemberReward
  Scenario: Multi-member places a lab visit order with reward only via UI and verifies via getOrderById API
    # ── UI : Login ──────────────────────────────────────────────────────────────
...
@hybridLabOrderMemberCoupon
  ...
  # ─────────────────────────────────────────────────────────────────────────────
  # Scenario 5 : Non-Member + Coupon – Lab Visit – Pay Online
  # ─────────────────────────────────────────────────────────────────────────────

@hybridLabOrderNonMemberCoupon
  Scenario: Single non-member places a lab visit order via UI with coupon and verifies via getOrderById API
    # ── UI : Login ──────────────────────────────────────────────────────────────
    ...
    Then capture amount to pay
    Then calculate expected final amount
    # ── API : Price Calculation Validation with Coupon ────────────────────────
    Then calculate expected total from API prices
    Then checkout total should match API calculated total
    And log the calculation breakdown
    Then validate cart amount to pay
  ...
  # ─────────────────────────────────────────────────────────────────────────────
  # Scenario 6 : Multi-Member + Coupon – Lab Visit – Pay Online
  # ─────────────────────────────────────────────────────────────────────────────
...
@hybridMultiMemberCoupon
  ...
  # ─────────────────────────────────────────────────────────────────────────────
  # Scenario 7 : Multi-Member Non-Member + Coupon – Lab Visit – Pay Online
  # ─────────────────────────────────────────────────────────────────────────────

@hybridMultiMemberNonMemberCoupon
  Scenario: Multi-member (non-member) places a lab visit order with proportional coupon split via UI and verifies via API
    # ── UI : Login ──────────────────────────────────────────────────────────────
  ...
  Scenario: Single member places a lab visit order via UI and verifies via getOrderById API
    ...
    Then generate API response capture report for validation analysis
  # ─────────────────────────────────────────────────────────────────────────────
  # Scenario 4 : Single Non-Member – Lab Visit – Pay Online
  # ─────────────────────────────────────────────────────────────────────────────