...
public class AddressAPITest extends BaseTest {
    ...
    @Test(priority = 11, dependsOnMethods = "com.mryoda.diagnostics.api.tests.cart.AddToCartAPITest.testAddToCart_ForNonMember", 
          description = "🏠 ADDRESS MANAGEMENT: Add Delivery Address for Non-Member - Verify existing non-member can add delivery address with proper location validation")
    ...
    // ---------------------------------------------------------
    @Test(priority = 11, dependsOnMethods = "com.mryoda.diagnostics.api.tests.cart.AddToCartAPITest.testAddToCart_ForMember", description = "QA Automation: Verify Add Address For Member")
    ...
    // ---------------------------------------------------------
    @Test(priority = 12, dependsOnMethods = "com.mryoda.diagnostics.api.tests.cart.AddToCartAPITest.testAddToCart_ForNewUser", description = "QA Automation: Verify Add Address For New User")
